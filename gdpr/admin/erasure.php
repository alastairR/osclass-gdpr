...
<div class="row">
    <div class="col-md-6">
        ...
        <form class="card" action="<?php echo osc_route_admin_url('gdpr-admin-erasure'); ?>" method="POST">
            <input name="paction" value="submit" type="hidden"/>
            <div class="card-body">
                <h2 class="mr-3"><?php _e('Right to erasure', 'gdpr'); ?></h2>
                <div class="col-md-12">
                    <div class="form-group pt-3">  
                        <label class="d-block custom-switch mb-3">
                            <input id="remove_account_enabled" type="checkbox" name="remove_account_enabled" value="1" <?php echo (osc_get_preference('remove_account_enabled', 'gdpr')=="1") ? 'checked' : ''; ?> class="custom-switch-input">
                            <span class="custom-switch-indicator"></span>
                            <span class="custom-switch-description"><?php _e('Check this to automatically add "Remove account" section under <em>user menu</em>.', 'gdpr'); ?></span>
                        </label>
                    </div>
                </div>
