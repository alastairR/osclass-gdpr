...
<span class="hljs-variable">$gdpr_error_message</span> = osc_get_preference(<span class="hljs-string">'error_agree_text_'</span> . osc_current_user_locale(), <span class="hljs-string">'gdpr'</span>);
...
<span class="hljs-variable">$gdpr_error_message</span> = osc_get_preference(<span class="hljs-string">'error_agree_text_'</span> . <span class="hljs-variable">$current_locale</span>, <span class="hljs-string">'gdpr'</span>);
<span class="hljs-keyword">if</span>(<span class="hljs-variable">$gdpr_error_message</span>==<span class="hljs-string">""</span>) {
