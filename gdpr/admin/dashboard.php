            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo osc_route_admin_url('gdpr-admin-settings'); ?>" class="btn btn-primary btn-block">Manage</a>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo osc_route_admin_url('gdpr-admin-erasure'); ?>" class="btn btn-primary btn-block">Manage</a>
                    </div> 
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="text-center mt-3">
                        <a href="<?php echo osc_route_admin_url('gdpr-admin-portability'); ?>" class="btn btn-primary btn-block">Manage</a>
                    </div>
                </div>
            </div>
        </div>
